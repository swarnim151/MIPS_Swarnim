...
addi $a0, $a0, 5      #PRINTING 8 by adding 2 and 6 and storing the result in $a0
syscall
...
addi $a0, $a0, -4             #PRINTING n, decimal value for 'n' in ascii is 110 (114-4)
syscall

addi $a0, $a0, -5             #PRINTING i, decimal value for 'i' in ascii is 105 (110-5)
syscall

addi $a0, $a0, 4            #PRINTING m, decimal value for 'm' in ascii is 109 (105+4)
syscall
